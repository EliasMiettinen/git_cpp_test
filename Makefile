...
cpp_git_test-Linux-Debug:
	 $(PROJECTBUILD) cpp_git_test Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

cpp_git_test-Linux-DebugGame:
	 $(PROJECTBUILD) cpp_git_test Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

cpp_git_test-Linux-Shipping:
	 $(PROJECTBUILD) cpp_git_test Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

cpp_git_test-Linux-Test:
	 $(PROJECTBUILD) cpp_git_test Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

cpp_git_test:
	 $(PROJECTBUILD) cpp_git_test Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

cpp_git_testEditor-Linux-Debug:
	 $(PROJECTBUILD) cpp_git_testEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

cpp_git_testEditor-Linux-DebugGame:
	 $(PROJECTBUILD) cpp_git_testEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

cpp_git_testEditor-Linux-Shipping:
	 $(PROJECTBUILD) cpp_git_testEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

cpp_git_testEditor-Linux-Test:
	 $(PROJECTBUILD) cpp_git_testEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

cpp_git_testEditor:
	 $(PROJECTBUILD) cpp_git_testEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
